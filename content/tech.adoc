...
:keywords: technology, software development, open source, patents, contributions
:idprefix:
:linkattrs:
...
'''
link:resume/resume.html[Visit my Resume^] or View my link:resume/resume.pdf[Resume in PDF format^] link:resume/resume-zoomed.pdf[(Zoomed)^]
